...
try:
    ...
    def therapy_cat_overview(*args, **kwargs):
        return "Entschuldigung, Miau kann derzeit nicht sprechen (API nicht verfügbar). Bitte installiere: pip install google-genai"
...
class TherapyCatInterface:
    ...
    def chat_with_cat_general(self):
        ...
        self.clear_screen()
        print("=" * 70)
        print("CHAT MIT MIAU - Therapie-Katze")
        print("=" * 70)
    ...
    def chat_about_entry(self):
        ...
        print("\nMiau analysiert diesen Eintrag...\n")
    ...
    def show_cat_overview(self):
        ...
        self.clear_screen()
        print("=" * 70)
        print("MIAU ANALYSIERT DEINE EINTRÄGE...")
        print("=" * 70)
